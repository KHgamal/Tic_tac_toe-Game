...
//For x shape , result of match , whose turn ;
TextStyle xStyle=const TextStyle(fontSize: 40,color: Colors.red,fontWeight: FontWeight.bold);

//For O shape , GameOver word ;
